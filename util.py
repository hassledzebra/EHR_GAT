...
#   print('selected_majority_indices: ',selected_majority_indices)
  ...
  edge_index_balanced, edge_attr_balanced = subgraph(extended_indices, data.edge_index, data.edge_attr,relabel_nodes=True)
...
def train_test_split_homodata(data, train_ratio=0.8, offset = 20):
  ...
  num_train = int(train_ratio * len(data.y))
  ...
  print(train_indices)
  print(test_indices)
  print(torch.tensor(range(0,offset)))
